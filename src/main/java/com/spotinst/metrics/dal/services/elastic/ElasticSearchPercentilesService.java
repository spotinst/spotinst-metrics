...
public class ElasticSearchPercentilesService extends BaseElasticSearchService implements IElasticSearchPercentilesService {
    ...
    //TODO Tal: Need to handle the new logic here
//    @Override
...
//
//    //region Filters
//    private void addTopLevelFilters(BoolQuery boolQuery, ElasticMetricDateRange dateRange, String accountId,
//                                    String namespace) {
...
//    }
//
//    private void addFilterOutZeroes(BoolQuery boolQuery, List<String> fields) {
//        for (String field : fields) {
//            boolQuery.mustNot(QueryBuilders.termQuery(field, "0"));
//        }
//    }
//
//    private void addDimensionsFilter(BoolQuery boolQuery, List<ElasticMetricDimension> dimensions) {
...
//
//    //region Aggregations
//    private void addAggregations(SearchRequest.Builder searchSourceBuilder,
...
//            List<ElasticPercentileAggregation> requestedPercentiles, Aggregation aggregations) {
