...
//
//    //region Constructors
//    private ElasticSearchPercentilesService() {
//        super();
//
...
//
//    @Override
//    public ElasticPercentilesResponse getPercentiles(ElasticPercentilesRequest request, String index) throws IOException {
...
//
//        // execute query
//        SearchResponse        searchResponse = MetricsAppContext.getInstance().getElasticClient().search(searchRequest, RequestOptions.DEFAULT);
//        ElasticPercentilesResponse retVal         = parseResponse(searchResponse, percentiles);
//
//        totalStopWatch.stop();
//        long totalMillis = totalStopWatch.lastTaskTime().millis();
//        LOGGER.info("Percentiles request ES took: [{}], total took [{}] ms", searchResponse.getTook(),
//                    totalMillis);
//
//        return retVal;
//
...
//        dimensions.forEach(dimension -> boolQuery.filter(QueryBuilders.termQuery(
//                DIMENSIONS_FIELD_NAME_PREFIX + dimension.getName(), dimension.getValue())));
//    }
//    //endregion
//
//    //region Aggregations
//    private void addAggregations(SearchSourceBuilder searchSourceBuilder, List<ElasticPercentileAggregation> percentiles) {
...
//                    AggregationBuilders.percentiles(percentile.getAggName()).field(fieldName)
//                                       .percentiles(percentile.getPercentile()));
//
//            searchSourceBuilder.aggregation(AggregationBuilders.filter(String.format(COUNT_AGG_NAME_TEMPLATE,
//                                                                                         percentile.getAggName()),
...
//
//            ElasticPercentileAggregationResult result = new ElasticPercentileAggregationResult(aggName, pValue, (int) docCount);
//
//            retVal.add(result);
//        }
//
