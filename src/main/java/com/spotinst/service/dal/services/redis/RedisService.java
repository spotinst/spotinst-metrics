...
import com.spotinst.service.commons.configuration.RedisConfig;
import com.spotinst.service.commons.utils.ExecutorUtils;
...
public class RedisService {
    ...
    private RedisService() {
        ...
        try {
            RedisConfig redisConfig = SampleAppContext.getInstance().getConfiguration().getRedisConfiguration();
    ...
    public Boolean setValue(String key, String value, Integer expire) throws RedisException {
        Boolean retVal;
        Jedis   resource  = null;
        Date    startTime = SampleAppContext.getInstance().getSystemClock().getCurrentTime();
        ...
        try {
            ...
            Date endTime  = SampleAppContext.getInstance().getSystemClock().getCurrentTime();
