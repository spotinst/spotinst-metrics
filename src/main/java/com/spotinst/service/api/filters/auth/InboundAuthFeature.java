...
import com.spotinst.service.api.filters.account.SampleResolveAccountIdRequestFilter;
    ...
    public void configure(ResourceInfo resourceInfo, FeatureContext context) {
        ...
        if (resourceInfo.getResourceMethod().getDeclaringClass().getName().contains(SWAGGER_CLASS) == false) {
            ...
            switch (simpleName) {
                ...
                default: {
                    context.register(SampleAuthRequestFilter.class);
                    context.register(SampleResolveAccountIdRequestFilter.class);
                }
            }
        }
    }
